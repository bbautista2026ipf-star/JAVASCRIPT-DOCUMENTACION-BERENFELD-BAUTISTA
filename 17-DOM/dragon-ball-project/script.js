...
const btnVerPersonajes = document.querySelector("#btnVerPersonajes");
const rowContainer = document.querySelector("#rowContainer");
const formulario = document.querySelector("#formulario");

const cargarPersonajes = (arregloDePersonajes) => {
  // tarea de agregar o cargar los personajes
    ...
    rowContainer.innerHTML += `
          ...
          <div class="card" style="width: 10rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">${personaje.race}</p>
              <a href="#" class="btn btn-warning btn-ver-mas">Ver más</a>
...
// btnVerPersonajes.addEventListener("click", () => {
//     // aca va la logica que se ejecuta cuando se hace un click
//     cargarPersonajes(personajes)
// })
...
rowContainer.addEventListener("click", (e) => {
  ...
  if (e.target.classList.contains("btn-ver-mas")) {
    // const personajeEncontrado = personajes.find(personaje => personaje.id === 8)
    const contenedorPrincipalMasCercano = e.target.closest(".col-3");
    const idDelPersonaje = Number(contenedorPrincipalMasCercano.dataset.id);
    ...
    alert(personajeEncontrado.description);
  }
});
...
formulario.addEventListener("submit", (e) => {
  ...
  // renderizo nuevamente el arreglo en el html
  cargarPersonajes(personajes);
});
