...
// parrafo.textContent = "Editado desde javascript"
...
inputRange.addEventListener("input", () => {
  valor.textContent = inputRange.value;
});
...
// //                 0        1        2
// const colores = ["yellow", "black", 2, true, {animal: "perro", edad: 10}]

// console.log(colores.length);

// // La edad del perro es de 10 y es yellow.
// console.log(`La edad del ${colores[4].animal}es de ${colores[4].edad} y es ${colores[0]}`);
